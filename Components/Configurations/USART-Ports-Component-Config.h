...
#define USART_PORTS_MEM_SECTION
//------------------------------------------------------------------------------
...
#define SERIAL1_TX_CIRCLE_BUF_MEM_SECTION
#define SERIAL1_RX_CIRCLE_BUF_MEM_SECTION
#define SERIAL1_RX_BUFFER_MEM_SECTION
...
#define SERIAL6_TX_CIRCLE_BUF_MEM_SECTION
#define SERIAL6_RX_CIRCLE_BUF_MEM_SECTION
#define SERIAL6_RX_BUFFER_MEM_SECTION
